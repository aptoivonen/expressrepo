  ...
  async.parallel(
    ...
    function (err, results) {
      ...
      if (results.book_bookinstances.length > 0) {
        // Book has book instances dependent on it. Render in same way as for GET route.
        res.render("book_delete", {
          title: "Delete Book",
          book: results.book,
          book_bookinstances: results.book_bookinstances,
        ...
        //Book has no book instances dependent on it. Delete object and redirect to the list of books.
